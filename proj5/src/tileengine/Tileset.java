...
public class Tileset {
    ...
    public static final TETile HFLOOR = new TETile('·', new Color(128, 192, 128), Color.blue, "highlighted floor", 2);
    public static final TETile HAVATAR = new TETile('@', Color.white, Color.blue, "you", 0);
    public static final TETile HFLOWER = new TETile('❀', Color.magenta, Color.blue, "highlighted flower", 6);
}
